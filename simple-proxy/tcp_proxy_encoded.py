...
# Proxy开放的端口号
LOCAL_PORT = config["proxy_port"]
# 连接的远程服务器与端口，修改成你的远程服务器地址
# REMOTE_ADDR = config["proxy_server"]
# REMOTE_PORT = config["proxy_server_port"]

# Proxy开放的端口号
# LOCAL_PORT = 7088
# 连接的远程服务器与端口，修改成你的远程服务器地址
REMOTE_ADDR = "ec2-54-251-155-96.ap-southeast-1.compute.amazonaws.com"
REMOTE_PORT = 7088
